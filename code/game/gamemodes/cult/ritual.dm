...
/obj/item/weapon/tome
	...
	tomedat = {"<html>
				...
				<h3>Communicate</h3>
				Invoking this rune allows you to relay a message to all cultists on the ship and nearby space objects.
				<h3>Stun</h3>
...
//		usr << browse(null, "window=tank")
	...
	attack(mob/living/M as mob, mob/living/user as mob)
		...
		msg_admin_attack("[key_name_admin(user)] used [name] on [key_name_admin(M)] (<A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[user.x];Y=[user.y];Z=[user.z]'>JMP</a>)")
