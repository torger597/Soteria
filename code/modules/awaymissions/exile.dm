//////Exile implants will allow you to use the ship gate, but not return home. This will allow security to exile badguys/for badguys to exile their kill targets////////
