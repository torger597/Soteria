/*
 *
 *For housing procs and things related to the viewing of Ship Directives.
...
/client/proc/directiveslookup(var/screen = 1, var/queryid="")
	var/dat = "<div align='center'><b>Ship Directives<br>NanoTrasen<br>NSS Hypatia</b></div><br>"
