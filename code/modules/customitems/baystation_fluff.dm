...
/obj/item/clothing/under/fluff/olddressuniform //desiderium: Momiji Inubashiri
	...
	desc = "A retired Ship Head of Staff uniform, phased out twenty years ago for the newer jumpsuit design, but still acceptable dress. Lovingly maintained."
	icon = 'icons/obj/custom_items.dmi'
