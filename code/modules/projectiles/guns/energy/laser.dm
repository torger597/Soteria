...
/obj/item/weapon/gun/energy/laser/captain
	...
	desc = "This is an antique laser gun. All craftsmanship is of the highest quality. It is decorated with assistant leather and chrome. The object menaces with spikes of energy. On the item is an image of the NEV Soteria. The ship is exploding."
	force = 10
	origin_tech = null
	var/charge_tick = 0
	var/damaged = 0
