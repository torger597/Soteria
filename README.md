...
### LICENSE
Soteria, as it is derived from Baystation12, is licensed under the GNU Affero General Public License version 3, which can be found in full in LICENSE-AGPL3.txt.
